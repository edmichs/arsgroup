...
<section class="testomonials mt-5 mb-3">
    <div class="container-fluid">
        <div class="row text-center">
                <div class="col-lg-4">
                        <a href="{{ route('projet_add_path') }}" class="btn btn-danger"> <i class="fa fa-plus"></i> Nouveau Devis</a>
                </div>
                <div class="col-lg-4">
                    <a href="" class="btn btn-light">Devis En cours</a>
                 </div>
                <div class="col-lg-4">
                    <a href="" class="btn btn-light">Devis Traité</a>
...
<section class="showcase mb-5" style="background-image: url(../img/ARS-4-1024x158.png)" >
    <div class="container ">
        <form action="{{ route('devis_add_path') }}" method="post">
            @csrf
            <div class="row ">
                <div class="col-12">
                    <div class="col-lg-6" style="float: left">
                        ...
                        <div class=" form-group mt-2 mb-2">
                            <input type="text" name="name" id="name" class="form-control " placeholder="Nom du Devis"  >
                            @error('name')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-12 col-lg-12 form-group text-center" >
                    <textarea name="simple_description" id="" cols="120" rows="10" placeholder=" description du Devis "></textarea>
