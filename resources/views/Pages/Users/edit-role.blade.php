...
<div class="page-content-wrap">
        ...
        <form class="form-horizontal" method="POST" action="{{ route('role_update_path') }}">
                {{ csrf_field() }}
                @if(session('message'))
                <div class="row">
            ...
            <div class="form-group{{ $errors->has('id') ? ' has-error' : '' }}" hidden>
                    ...
                    <div class="col-md-6">
                        <input id="id" type="text" class="form-control" name="id" value="{{ $role->id }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('libelle') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="libelle" type="text" class="form-control" name="libelle" value="{{ $role->libelle }}" required autofocus>
                ...
                <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                        <input id="description" type="description" class="form-control" name="description" value="{{ $role->description }}" required>
