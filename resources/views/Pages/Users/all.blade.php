            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="btn-group pull-right">
                            <a href="{{ route('user_add_path') }}" class="btn btn-info "><i class="fa fa-plus"></i> Ajouter Un nouvel Utilisateur</a>
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <a
                                            href="{{ url("/utilisateur/edit/{$user->id}") }}"
                                                id="editButton"
                                                title="Modifier"><i class=" btn btn-warning fa fa-pencil"></i></a>
                                        <a  title="Supprimer"
                                        href="{{ url("/utilisateur/delete/{$user->id}") }}"
                                           id="deleteButton"
                                           class="deleteButton"
