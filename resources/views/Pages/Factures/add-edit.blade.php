...
@section('css')
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">Etablir nouvelle Facture</li>
    </ul>
    <!-- END BREADCRUMB -->
    ...
    <div class="page-content-wrap">
        <div class="row">
            <form id="form" role="form" class="form-horizontal" method="post" action="{{route('facture_add_path')}}">
                {{ csrf_field() }}
                @if(session('message'))
                    <div class="row">
                ...
                <div class="col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="numero_facture" id="numero_facture" class="form-control text-center" value="{{$numerofacture}}">
                        </div>
                    </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <hr >
                    <h4 class="text-center"><i class="fa fa-plus"></i>Ajouter des articles a la facture</h4>
                    <br>
                    <div class=" col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="prix_vente_unitaire" id="prix_vente_unitaire" class="form-control">
                        </div>
                    ...
                    <div class="col-md-12">
                        <hr>
                        <br>
                        <h4>Listes des articles de la facture</h4>
            ...
            <form id="form-suppr" role="form" method="POST" action="{{route('delete_article_path')}}">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="supprimer" onclick="alert('123');" class="btn btn-primary">Valider</button>
